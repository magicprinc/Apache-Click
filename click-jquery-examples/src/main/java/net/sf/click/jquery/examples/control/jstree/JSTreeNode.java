...
public class JSTreeNode {
  ...
  protected List<JSTreeNode> children;
   ...
   */
  public void remove (@NonNull JSTreeNode child) {
    if (getChildren() == null) {
      children = new ArrayList<>();
    }
  ...
  private String generateId() {
    return Long.toString(Math.abs(ThreadLocalRandom.current().nextLong(Long.MAX_VALUE)));
  }
}