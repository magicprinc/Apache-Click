...
public class FormTest extends TestCase {
	...
	public void setUp() {
		...
		assertEquals(0, testForm.getControls().indexOf(trackField));
		// trackField index: #fieldList=0
		assertEquals(0, testForm.getFieldList().indexOf(trackField));
	}
	...
	public void testInsertOrderAfterAddingField() {
		...
		assertEquals(0, testForm.getControls().indexOf(nameField));
		// nameField index: #fieldList=0
		assertEquals(0, testForm.getFieldList().indexOf(nameField));

		// trackField index: #controls=1
		assertEquals(1, testForm.getControls().indexOf(trackField));
		// trackField index: #fieldList=1
		assertEquals(1, testForm.getFieldList().indexOf(trackField));
	}
	...
	public void testInsertOrderAfterInsertingTable() {
		...
		assertEquals(0, testForm.getControls().indexOf(table));
		// table index: #fieldList=-1
		assertEquals(-1, testForm.getFieldList().indexOf(table));
	...
	public void testInsertOrderAfterInsertingButton() {
		// Check that the fieldList includes only hidden field, FORM_NAME, thus size is 1
		assertEquals(1, testForm.getFieldList().size());
		...
		assertEquals(0, testForm.getControls().indexOf(button));
		// button index: #buttonList=0
		assertEquals(0, testForm.getButtonList().indexOf(button));
