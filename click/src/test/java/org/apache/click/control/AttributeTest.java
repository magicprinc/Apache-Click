...
public class AttributeTest extends TestCase {
  ...
  public void testAttributesAndStylesPerf() {
    ...
    for (int i = 0; i < loops; i++) {
      ...
      nameField.setStyle("color", "blue");//replace color
      nameField.setStyle("border", "1px solid black");//add border
      val tmp = nameField.toString();
    }
    System.out.println("Time for setStyle -> " + (System.currentTimeMillis() - start));
    ...
    System.out.println("Time for setAttribute-> " + (System.currentTimeMillis() - start));
    ...
    System.out.println("Time for setAttribute and getAttribute -> " + (System.currentTimeMillis() - start));
  }
  ...
  public void testAttributesAndClassPerf() {
    ...
    System.out.println("Time for addStyleClass -> " + (System.currentTimeMillis() - start));
