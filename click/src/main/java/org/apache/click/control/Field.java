...
public abstract class Field extends AbstractControl implements Stateful {
  ...
  /** The Field request focus flag.
   true if the field has requested focus */
  @Setter protected boolean focus;

  /** The parent Form ~ Field's the parent <tt>Form</tt>. */
  @Setter protected Form form;

  /** The Field help text (the help text of the Field). */
  @Setter protected String help;
  ...
  /**
   * Return true if the Field type is hidden ({@code <input type="hidden"/>}) or false otherwise.
   *
