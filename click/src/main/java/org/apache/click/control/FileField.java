...
public class FileField extends Field {
  ...
  @Getter @Setter protected int size = 20;
   ...
   */
  @Override public Object getValueObject(){ return this.fileItem;}
  ...
  public void bindRequestValue() {
    fileItem = Context.getThreadLocalContext().getFileItem(getName());
  }
