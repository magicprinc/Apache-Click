...
public abstract class AbstractContainerField extends Field implements Container {
   ...
   */
  @Getter protected final List<Control> controls = new ArrayList<>();

  /** The map of controls keyed by field name.
   the map of controls where each map's key / value pair will consist of the control name and instance.
   @see org.apache.click.control.AbstractContainer#getControlMap()
   */
  @Getter protected final Map<String, Control> controlMap = new HashMap<>();
