...
public class CountrySelect extends Select {
  ...
  public Locale getLocale() {
    return locale != null ? locale : Context.getThreadLocalContext().getLocale();
  }
  ...
  protected void loadOptionList() {
    ...
    Set<Option> countryList = new TreeSet<>(new OptionLabelComparator(getLocale()));
    ...
    for (String isoCountry : isoCountries){
      Locale tmpLocale = new Locale("en", isoCountry);
  ...
  static class OptionLabelComparator implements Comparator<Option> {
     ...
     */
    @Override public final int compare (Option o1, Option o2) {
      return comparator.compare(o1.getLabel(), o2.getLabel());
    }
  }//OptionLabelComparator
}