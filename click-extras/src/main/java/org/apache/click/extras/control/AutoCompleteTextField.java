...
public abstract class AutoCompleteTextField extends TextField {
   ...
   * instead
   */
  @Override public void addBehavior (@NonNull Behavior behavior){
    throw new UnsupportedOperationException("AutoCompleteTextField uses internal behavior, extra behaviors are not supported");
  }
  ...
  protected Behavior createBehavior() {
    ...
    return new DefaultAjaxBehavior() {
