...
public class LinkDecorator implements Decorator, Serializable {
   ...
   */
  public LinkDecorator (@NonNull Table table, @NonNull AbstractLink link, @NonNull String idProperty) {
    this.table = table;
   ...
   * @param idProperty the row object identifier property name
   */
  public LinkDecorator (@NonNull Table table, @NonNull AbstractLink @NonNull [] links, @NonNull String idProperty){
    this.table = table;
   ...
   */
  public LinkDecorator(Table table, AbstractLink[] links, String idProperty, String parameterName){
   ...
   * @param idProperty the row object identifier property name
   */
  public LinkDecorator (@NonNull Table table, @NonNull ActionButton button, @NonNull String idProperty){
    this.table = table;
   ...
   * @param parameterName a parameter name for the row object identifier
   */
  public LinkDecorator(Table table, ActionButton[] buttons, String idProperty, String parameterName){
   ...
   * @param idProperty the row object identifier property name
   */
  public LinkDecorator (@NonNull Table table, @NonNull ActionButton @NonNull [] buttons, @NonNull String idProperty){
    this.table = table;
  ...
  class PageNumberControl extends AbstractControl {
    ...
    protected boolean anyLinkOrButtonClicked() {
      ...
      if (linksArray != null) {
        for (AbstractLink link : linksArray){
          if (link instanceof ActionLink actionLink){
      ...
      if (buttonsArray != null) {
        for (ActionButton button : buttonsArray){
