...
public class PickList extends Field {
    ...
    for (Object object : objects){
      try {
        ...
        if (labelResult != null) {
          ...
          option = new Option(""+valueResult);// null?
        }
  ...
  public void bindRequestValue() {
    ...
    String[] parameterValues = Context.getThreadLocalContext().getRequest().getParameterValues(getName());
  ...
  public Object getState() {
    val selectedState = getSelectedValues();
  ...
  public void setState(Object state) {
    ...
    List<String> localSelectedState = new ArrayList<>(pickListState.length);
    Collections.addAll(localSelectedState, pickListState);
  ...
  protected void renderTemplate(HtmlStringBuffer buffer, Map<String, Object> model) {
    buffer.append(Context.getThreadLocalContext().renderTemplate(PickList.class, model));
  }
}