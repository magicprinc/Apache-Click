...
public class MenuFactory implements Serializable {
  ...
  protected final static Set<String> DEFAULT_ATTRIBUTES = new HashSet<>();

  /** The menu cache. */
  private static final Map<String, Menu> MENU_CACHE = new ConcurrentHashMap<>();
  ...
  public Menu getRootMenu(String name, String fileName) {
    return getRootMenu(name, fileName, new RoleAccessController(), true, null);
  }
   ...
   * classpath
   */
  public Menu getRootMenu (@NonNull String name,
   ...
   */
  protected Menu buildMenu (@NonNull Element menuElement,
      @NonNull AccessController accessController,
      Class<? extends Menu> menuClass
  ){
  ...
  protected Menu createMenu(Class<? extends Menu> menuClass) {
    try {
      ...
      throw new RuntimeException("Error occurred create new menu of type "+ menuClass);
    }
  }
   ...
   */
  protected Menu loadFromMenuXml (@NonNull String name,
      @NonNull String fileName,
      @NonNull AccessController accessController,
      Class<? extends Menu> menuClass
  ){
   ...
   */
  protected Menu retrieveRootMenu (@NonNull String name) {
   ...
   */
  protected void cacheRootMenu (@NonNull Menu menu) {
