...
public abstract class Step extends SimplePanel {
    ...
    public boolean onCancel() {
        ...
        Context.getThreadLocalContext().setFlashAttribute("message", "You have cancelled the client creation process.");
    ...
    public final void init() {
        ...
        getPreviousButton().setActionListener((ActionListener) source->onPrevious());
        ...
        next.setLabel("Next >");
        getNextButton().setActionListener((ActionListener) source->onNext());
        localForm.add(next);
        ...
        getFinishButton().setActionListener((ActionListener) source->onFinish());
        ...
        getCancelButton().setActionListener((ActionListener) source->onCancel());
