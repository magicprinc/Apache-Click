...
/**
 * This is a simple solution to get the app working in google app engine.
 * As there is no java.awt.Color in google app, we will use this classe internally.
 * The code is from the jdk, minus unused references to a ColorSpace.
 * @author steff
 */
public class Color {
