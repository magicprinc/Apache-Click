...
import net.sf.clickclick.examples.jquery.util.JQInlineValidationHelper;
...
public class JqueryValidation1Demo extends BorderPage {
    ...
    public void onInit() {
        ...
        form.getJQueryHelper().setTemplate("/clickclick/example/template/jquery.validate1.template.js");
