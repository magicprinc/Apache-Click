...
public class Chainer {
    ...
    private List setterInfos = new ArrayList();
    ...
    private void collectImports() {
        ...
        for (int i = 0, t = setterInfos.size(); i < t; i++) {
            addImport(((SetterInfo) setterInfos.get(i)).getType());
        }
    }

    private void addImport(Class importedClass) {
        String importName = importedClass.getName();
    ...
    public void writeConstructors() throws Exception {
        ...
        for (int i = 0, t = constructors.length; i < t; i++) {
    ...
    private void writeMethods() throws Exception {
        for (int i = 0, t = setterInfos.size(); i < t; i++) {
            SetterInfo setterInfo = (SetterInfo) setterInfos.get(i);
    ...
    private void collectSetterInfos() throws Exception {
        ...
        for (int i = 0, t = propertyDescriptors.length; i < t; i++) {
