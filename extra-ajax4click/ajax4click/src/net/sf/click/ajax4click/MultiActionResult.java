...
public class MultiActionResult extends ActionResult {
   ...
   /**
    ...
    private HeadElementsHolder getHeadElements() {
        ...
        List<JsScript> jsScriptElements = new ArrayList<JsScript>();
    ...
    private void orderJavaScriptElements(List<Element> allJsElements,
        ...
        Iterator it = allJsElements.iterator();
     ...
     * elements.
     */
    private class HeadElementsHolder {
        public List<Element> headElements = new ArrayList<Element>();

        public List<JsScript> jsScriptElements = new ArrayList<JsScript>();
    }
}
